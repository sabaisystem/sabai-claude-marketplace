...
export function createServer() {
    ...
    // ============ GMAIL API TOOLS ============
    // gmail_search
    server.tool("gmail_search", "Search emails using Gmail query syntax. Supports operators like from:, to:, subject:, is:unread, has:attachment, newer_than:, older_than:, etc.", {
    ...
    // gmail_get_message
    server.tool("gmail_get_message", "Get full details of an email message including body content", {
    ...
    // gmail_list_inbox
    server.tool("gmail_list_inbox", "List recent emails from inbox", {
    ...
    // gmail_create_draft
    server.tool("gmail_create_draft", "Create an email draft", {
    ...
    // gmail_reply
    server.tool("gmail_reply", "Reply to an email thread", {
    ...
    // gmail_add_labels
    server.tool("gmail_add_labels", "Add labels to a message", {
    ...
    // gmail_remove_labels
    server.tool("gmail_remove_labels", "Remove labels from a message", {
        messageId: z.string().describe("Message ID"),
    ...
    // gmail_trash
    server.tool("gmail_trash", "Move a message to trash", {
    ...
    registerAppTool(server, "editor_send_email", {
